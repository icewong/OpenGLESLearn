...
//  OpenGLES_01
//
//  Created by SkyLight on 2017/9/18.
//  Copyright © 2017年 SkyLight. All rights reserved.
//

#import "ViewController.h"

@interface ViewController ()<GLKViewDelegate>
//GLKit用来处理 OpenGL ES相关配置，可以初始化出兼容不同openGL ES版本的上下文环境
@property(strong, nonatomic)EAGLContext *context;
@property(assign, nonatomic)GLint shaderProgram;
@end
...
- (void)drawQuadrangle {
    ...
    // stride: 每一个点包含几个byte，本例中就是6个GLfloat，x,y,z,r,g,b
    // ptr: 数据开始的指针，位置就是从头开始，颜色则跳过3个GLFloat的大小
    glVertexAttribPointer(positionAttribLocation, 4, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (char *)triangleData);
    glVertexAttribPointer(colorAttribLocation, 4, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (char *)triangleData + 3 * sizeof(GLfloat));
